...
export default function Home() {
	...
	useEffect(() => {
		if(id) {
			...
			setInterval(() => {
				setResultTimeoutValue(old => old - 1000)
			}, 1000)
	...
	return (
		<main className="flex flex-col gap-4 items-center py-16">
			<Formik
				...
				{({ resetForm }) => {
					return (
						<Form className="flex flex-col gap-4">
							...
							<Field name="identifier" className="py-2 px-4 rounded-md h-11 text-slate-800 outline-none" />
